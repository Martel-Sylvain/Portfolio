...
const About = () => {
    return (
        <div className="w-screen h-screen flex items-start justify-center bg-customBlack">
            <div className='mx-10 mt-56 text-customWhite text-5xl font-font26 leading-relaxed'>
                <p><span className='text-6xl font-font10'>Hi!
                </span> I'm <span className='text-customBlue font-font13 text-7xl'>Sylvain</span>,</p>
